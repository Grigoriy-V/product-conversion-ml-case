...
> **Current status (2026-07-19):** Steps 1–6 are accepted. The selected
...
>
> **Current nearest action:** stop for human direction. Step 7 is optional:
> decide whether the portfolio case needs a product operating point and
> validation-only threshold analysis. Do not tune or select anything on test.

**Статус:** шаги 1–6 приняты. Окружение: Python 3.12.4,
...
Остановиться для human direction. Шаг 7 опционален: решить, нужен ли
portfolio-кейсу продуктовый operating point и validation-only анализ порога.
Held-out test больше не использовать для выбора модели, preprocessing,
calibration или threshold.
