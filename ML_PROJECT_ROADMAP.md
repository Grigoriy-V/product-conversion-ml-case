...
> **Current status (2026-07-19):** Steps 1–7 are accepted. The selected
...
>
> **Current nearest action:** human decision whether to run a separately
> bounded model-improvement phase or freeze the model and proceed to step 8
> portfolio summary. Do not reopen test for either decision.
...
Остановиться для human decision: либо открыть отдельно ограниченную фазу
улучшения модели, либо заморозить текущую модель и перейти к шагу 8
portfolio summary. Held-out test больше не использовать для выбора модели,
preprocessing, calibration или threshold.
